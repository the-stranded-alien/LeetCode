...
// that each letter appears in at most one part. Note that the partition is done so that after
...
public:
    vector<int> partitionLabels(string s) {
        ...
        int l = s.length();
        for(int i = 0; i < l; i++) lastIdx[s[i]] = i;
...
void solve() {
	...
	vector<int> parts = soln->partitionLabels(s);
