...
public:
    bool squareIsWhite(string coordinates) {
        ...
        if(c1 == 'a' || c1 == 'c' || c1 == 'e' || c1 == 'g') {
        	if(c2 == '1' || c2 == '3' || c2 == '5' || c2 == '7') return false;
        	else return true;
        } else {
        	if(c2 == '1' || c2 == '3' || c2 == '5' || c2 == '7') return true;
        	else return false;
        }
    }
};
...
void solve() {
	// Main Code Goes Here !!
	string coordinates; cin >> coordinates;
	Solution *soln = new Solution();
	bool sqIsWhite = soln->squareIsWhite(coordinates);
	if(sqIsWhite) cout << "true" << nl;
	else cout << "false" << nl;
	return;
}
