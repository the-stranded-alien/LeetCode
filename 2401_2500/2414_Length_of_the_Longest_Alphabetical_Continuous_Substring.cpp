...
// in the alphabet. In other words, it is any substring of the string
// "abcdefghijklmnopqrstuvwxyz". For example, "abc" is an alphabetical continuous
// string, while "acb" and "za" are not.
...
void solve() {
	...
	cout << soln->longestContinuousSubstring(s);
