...
// form "first second third", where second comes immediately after first, and third comes immediately after second.
...
void solve() {
	...
	vs ans = soln->findOcurrences(text, first, second);
